...
public class ARDrone20NavData implements NavData
{
    ...
    private static final Logger log = Logger.getLogger(ARDrone20NavData.class.getName());
    ...
    public static NavData createFromData(ByteBuffer buf, int len) throws NavDataFormatException
    {
        ...
        ARDrone20NavData data = new ARDrone20NavData();
    ...
    private static void parseDemoNavData(ARDrone20NavData data, ByteBuffer buf, int offset) throws NavDataFormatException
    {
